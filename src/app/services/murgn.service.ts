...
export class murgnService {
  ...
  EMKTest(data:any) {
    ...
    return this.http.post<any>('https://10.20.209.2:9003/api/invSelfConfirmV2', data, this.httpOptions);
  }
  ...
  CheckEntryView(data:any) {
    return this.http.post<any>(`${this.gb.gApiserver}/api/datareqrachnTen`, data, this.httpOptions);
  }
