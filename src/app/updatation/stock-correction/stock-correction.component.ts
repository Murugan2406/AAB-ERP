...
export class StockCorrectionComponent implements OnInit, OnDestroy {
 ...
 searchItem = new FormControl();
    ...
    public progressval = 'indeterminate';

 SelectedMenuTitle ='Physical Stock Correction';
...
public dialog: MatDialog,
      ...
      this.subs.add(
        this.searchItem.valueChanges.pipe(debounceTime(600)).subscribe((myvardatas) => {
          ...
          this.subs.add(this.service.datareqrachn({
            reqMainreq: 'ItemSearch',
            Usr: this.globals.gUsrid,
            brcode: '0',
            var1: this.StkCorrectionType,
            var2: '0',
            var3: this.InameAutoSel,
            var4: '0',
            var5: '0',
            var6: '0',
            var7: '0',
    ...
    ngOnInit() {
      this.globals.SelectedRouteName = 'Update';
      this.globals.gmainMenuSelected = 'STOCK CORRECTION';
    ...
    UpdateStockDetail() {
      this.subs.add(this.service.datareqrachn({
        reqMainreq: 'UpdateStockOrSendtoApproval',
        Usr: this.globals.gUsrid,
        brcode: this.globals.gBrcodeString,
        var1: this.SelectionType,
        var2: this.StkCorrectionType,
        var3: this.Icode,
        var4: this.Itemname_val,
        var5: this.StkCurQty_val,
        var6: this.Rate,
        var7: this.Uom_val,
        var8: this.Category,
        var9: this.date,
        var10: this.CurQty,
        var11: this.globals.gTerCode,
        var12: this.globals.usrCaption,
        var13: '0',
        var14: '0',
        var15: '0',
        var16: '0',
    ...
    ViewPending() {
      ...
      this.subs.add(this.service.datareqrachn({
        reqMainreq: 'ViewStockCorrectionApprPending',
        Usr: this.globals.gUsrid,
